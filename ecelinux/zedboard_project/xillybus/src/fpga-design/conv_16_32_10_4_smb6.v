...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module conv_16_32_10_4_smb6_rom (
...
initial begin
    $readmemh("./conv_16_32_10_4_smb6_rom.dat", ram0);
    $readmemh("./conv_16_32_10_4_smb6_rom.dat", ram1);
end
...
conv_16_32_10_4_smb6_rom conv_16_32_10_4_smb6_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
